...
local themes = {
    ...
    tech = function()
        ...
        colors.bg1 = make_nk_color(0xff177772)
        colors.bg2 = make_nk_color(0xff29f9e5)
        colors.fg1 = make_nk_color(0x800c3d46)

        local color_tbl = custom_colors[2]

        color_tbl[indexes.NK_COLOR_TEXT] = colors.white            -- text color 
        -- color_tbl[indexes.NK_COLOR_WINDOW] = colors.techalpha        -- bg color 

        color_tbl[indexes.NK_COLOR_HEADER] = colors.techfg1                       -- header color 
        -- color_tbl[indexes.NK_COLOR_BORDER] = colors.white)            -- border color 
        ...
        color_tbl[indexes.NK_COLOR_BUTTON_ACTIVE] = colors.paynes_gray      -- button active color
        ...
        color_tbl[indexes.NK_COLOR_SELECT] = colors.techfg1                -- select color
        color_tbl[indexes.NK_COLOR_SELECT_ACTIVE] = colors.paynes_dark        -- select active color
        ...
        color_tbl[indexes.NK_COLOR_EDIT] = colors.techfg1            -- edit color 
        -- color_tbl[indexes.NK_COLOR_EDIT_CURSOR] = colors.light_blue)      -- edit cursor color

        color_tbl[indexes.NK_COLOR_COMBO] = colors.techfg1     -- combo color
