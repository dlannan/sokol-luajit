...
local tf 		= require("engine.nuklear.utils.transforms")
local themes 	= require("engine.nuklear.utils.themes")
local nuklear 	= require("engine.nuklear.style")
local wdgts     = require("engine.nuklear.widgets")
...
nuklear_gui.window_resized = function(self, data)
	...
	self:init(nuklear_gui.camera.url,  1.0)
