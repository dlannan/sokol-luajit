...
/*
    ...
    Cmdline:
        sokol-shdc -i ./projects/examples/samples/cube-sapp.glsl -o /home/dlannan/store1/Development/lua/repos/sokol-luajit/bin/shaderbin/shader_gen.h -l glsl410 -f sokol
