...
/*
    ...
    Cmdline:
        sokol-shdc -i ./projects/examples/samples/cube-sapp.glsl -o F:\dev\luajit\repos\sokol-luajit\bin\shaderbin\shader_gen_cube.h -l glsl410 -f sokol
...
#error "Please include sokol_gfx.h before shader_gen_cube.h"
#endif
...
*/
static const uint8_t vs_cube_source_glsl410[284] = {
...
*/
static const uint8_t fs_cube_source_glsl410[135] = {
...
static inline const sg_shader_desc* cube_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)vs_cube_source_glsl410;
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)fs_cube_source_glsl410;
