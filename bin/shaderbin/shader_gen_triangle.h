...
/*
    ...
    Cmdline:
        sokol-shdc -i ./projects/examples/samples/triangle-sapp.glsl -o F:\dev\luajit\repos\sokol-luajit\bin\shaderbin\shader_gen_triangle.h -l glsl410 -f sokol
...
#error "Please include sokol_gfx.h before shader_gen_triangle.h"
#endif
...
*/
static const uint8_t vs_triangle_source_glsl410[194] = {
...
*/
static const uint8_t fs_triangle_source_glsl410[135] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x34,0x31,0x30,0x0a,0x0a,0x6c,0x61,
    0x79,0x6f,0x75,0x74,0x28,0x6c,0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,
...
static inline const sg_shader_desc* triangle_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)vs_triangle_source_glsl410;
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)fs_triangle_source_glsl410;
