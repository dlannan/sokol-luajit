...
/*
    ...
    Cmdline:
        sokol-shdc -i ./projects/examples/samples/cube-sapp.glsl -o F:\dev\luajit\repos\sokol-luajit\bin\shaderbin\shader_gen_.h -l glsl410 -f sokol
...
#error "Please include sokol_gfx.h before shader_gen_.h"
#endif
