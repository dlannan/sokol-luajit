...
local function frame(void)
    ...
    -- im.igSliderFloat("float", f, 0.0, 1.0, "%.3f", im.ImGuiSliderFlags_None)
    -- im.igColorEdit3("clear color", state[0].pass_action.colors[0].clear_value, 0)
    -- if (im.igButton("Test Window", emptyVec2)) then state[0].show_test_window = not state[0].show_test_window; end
    -- if (im.igButton("Another Window", emptyVec2)) then state[0].show_another_window = not state[0].show_another_window end
    ...
    --     im.igSetNextWindowSize(winpos, im.ImGuiCond_FirstUseEver)
    --     im.igBegin("Another Window", state[0].show_another_window, 0)
    --     im.igText("Hello");
    --     im.igEnd();
    -- end
    ...
    --     im.igSetNextWindowPos(winpos, im.ImGuiCond_FirstUseEver, emptyVec2);
    --     im.igShowDemoWindow(0);
    -- end
