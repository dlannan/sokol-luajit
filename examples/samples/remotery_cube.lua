...
local function init()
    ...
    rmt_ctx = rmt.CreateGlobalInstance()
...
-- --------------------------------------------------------------------------------------
local sample1_hash = ffi.new("rmtU32[1]", {0})
local sample1_str  = "Frame-Cube-Setup"
local sample2_hash = ffi.new("rmtU32[1]", {0})
local sample2_str  = "Frame-Cube-Render"

local function frame()

    rmt._rmt_BeginCPUSample(sample1_str, rmt.RMTSF_Aggregate, sample1_hash)
